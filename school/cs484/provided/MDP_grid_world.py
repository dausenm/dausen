...
def gridworld_bellman():
    ...
    while True:
        ...
        if np.sum(np.abs(value - new_value)) < 1e-4:
            ...
            # plt.savefig('{}/images/figure_3_2.png'.format(dir_name))
            plt.show()
            plt.close()
            break
        value = new_value
...
def gridworld_linear_system():
    ...
    plt.show()
    # plt.savefig('{}/images/figure_3_2_linear_system.png'.format(dir_name))
    plt.close()
...
def gridworld_policy():
    ...
    while True:
        ...
        if np.sum(np.abs(new_value - value)) < 1e-4:
            draw_image(np.round(new_value, decimals=2))
            # plt.savefig('{}/images/figure_3_5.png'.format(dir_name))
            plt.show()
            plt.close()

            draw_policy(new_value)
            # plt.savefig('{}/images/figure_3_5_policy.png'.format(dir_name))
            plt.show()
            plt.close()
            break
        value = new_value
